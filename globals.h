...
#define MaxRate 96 
#define SIDEREAL_INTERVAL 15956313L
...
long lst_start = 0l;                // this marks the start lst when UT1 is set 
...
long siderealInterval       = SIDEREAL_INTERVAL;
long masterSiderealInterval = SIDEREAL_INTERVAL;
